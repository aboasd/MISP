...
<center>
...
</br><input type="text" name="text_spam" id="text_spam" style="color: #337ab7; background: #1D1F24; font-size: 13; height: 28px; width: 50%; padding: 5px; font-family: 'Consolas'; border: 1px solid #ccc; border-radius: 0px; outline:none;"></input>
</br><input type='submit' value='Add Numbers' name='add_numbers' style='margin-top:5px;border-radius:0;outline:none;' class='btn btn-outline-success'/>
</center>
 ...
 <thead class="header_table_bots">
    ...
    $sql = "SELECT * FROM smsspam";
	 ...
	 echo "<input type='submit' value='Delete' name='delete' style='margin-left:68px; outline:none; border-radius:0; margin-top:15px;' class='btn btn-outline-danger'/><br><br>";
