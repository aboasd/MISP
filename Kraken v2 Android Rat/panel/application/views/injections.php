...
<div class="content" style="padding-top:15px;background: rgba(46, 45, 44, 0.7);border-radius:0;box-shadow:0px 0px 2px #ffc20e;">
...
<?php
	...
	echo "<input type='text' name='textfind' value='$getFind' id='styled-select' style='color: #EDB749; background: #1D1F24; outline:none; width:15%;border: 1px solid black; border-color: rgba(255,255,255,.5); border-radius: 0px;'></input>";
...
<input type='submit' value='FIND' name='find' style='color: #EDB749; background: #1D1F24; outline:none; border-radius:0; border: 1px solid black; border-color: rgba(255,255,255,.5); border-radius: 0px; padding:3px;width:80px;'/>
</form>
