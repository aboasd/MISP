...
<div id='DIV_Server' style='margin-left:20px;width:25%; float:left;  min-height: 50px; margin-top:20px;	border: 0px solid black; border-color: #43717a; border-radius: 4px;' >
		...
		<input type='submit' value='Connect' onClick='sendDataCommand()' style='outline:none;border-radius:0;width: 90px; margin-top:2px; margin-right:0px;' class='btn btn-outline-success'/>
		<input type='submit' value='Disconnect' onClick='disconnect()' style='outline:none;border-radius:0;width: 107px; margin-top:2px; margin-right:5px;' class='btn btn-outline-danger'/>
		</br>
