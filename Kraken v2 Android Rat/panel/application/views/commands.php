...
<script type="text/javascript">
 ...
 <thead class="header_table_bots">
	...
	//	include 'config.php';
		...
		echo "<input type='submit' value='Delete' name='delete' style='margin-left:32px; margin-top:15px; outline:none; border-radius:0;' class='btn btn-outline-danger'/><br><br>";
