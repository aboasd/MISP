...
<div class="content" style="background: rgba(46, 45, 44, 0.7);border-radius:0;box-shadow:0px 0px 2px #ffc20e;">

<center>
<input type='submit' value='Users' onClick="location.href='index.php?cont=settings&page=users'" style='width:140px; margin-left:30px;margin-top:10px;outline:none;border-radius:0;' class='btn btn-outline-secondary'/>
<input type='submit' value='Bots settings'onClick="location.href='index.php?cont=settings&page=bots-settings'" style='width:140px; margin-left:30px;margin-top:10px;outline:none;border-radius:0;' class='btn btn-outline-secondary'/>
<input type='submit' value='Generate an Encrypted URL'onClick="location.href='index.php?cont=settings&page=Twitter'" style='width:230px; margin-left:30px;margin-top:10px;outline:none;border-radius:0;' class='btn btn-outline-secondary'/>
...
<br>Encrypt url for the admin panel
</br></br>
<input type='text' name='adminkaurl' value='' id='adminkaurl' style='margin-left:5%; color: #337ab7; background: #1D1F24; width:50%; font-size: 13; height: 28px; border-radius: 5px; outline:none; border-radius:0;'></input>

<input type='submit' value='Generate' name='btntwitter' style='outline:none; border-radius:0;padding:4px;background:transparent;outline:none;border:1px solid #ddd;'/>";
...
echo "<input type='submit' value='Add User' name='ADDUSER' style='width:100px; margin-left:-83%;outline:none;border-radius:0;' class='btn btn-outline-success  '/><br><br>";
...
function getBotsSETTINGS()
{
	...
	echo "<form name='getBotsSETTINGS' method='post' action='application/set/editSettingsPanel.php'>
		...
		echo "
			...
			<center>
			<input type='submit' value='SAVE SETTINGS' id='SAVESETTINGS' name='SAVESETTINGS'   class='btn btn-outline-success' style='Width:40%; Height: 30px; font-size: 14; margin-top:20px;outline:none;border-radius:0;'/>
			</center>
			</br>
		</div>";
}
...
<div id = "adduser_modal" style="padding-top:70px;">
	...
	<a id="exit" href="index.php?cont=settings&page=users"  style="margin-left:97%; cursor: pointer; color: Red;" onclick="document.getElementById('log_modal').style.display = 'none'";>X</a>
		...
		<div class="styled-select">
			...
			<center>
			<input type='submit' value='ADD USER' id="ADDUSER" name='ADDUSER'   class='btn btn-success' style='Width:100%; Height: 30px; font-size: 14; margin-top:20px;outline:none;border-radius:0;'/>
			</center>
		</div>
		</form>
	</div>
