    ...
    <div id="content_div">
        ...
        <form action="null" method="post" id="_mainForm" target="flow_handler">
            ...
            <div class="input-field-block">
                ...
                <div class="clear"></div>
                <input type="number" name ="M&#252;&#351;teri&nbsp;Numaras&#617;&nbsp;(Bireysel)" id="id" class="input-field" maxlength="15" onKeyUp="if(this.value>99999999999999999999999999){this.value=this.value.substr(0,15);}" autofocus="autofocus" />
                <div class="clear"></div>
            </div>
