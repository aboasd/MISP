...
<div style="clear:both"></div>
 ...
 <form  method="post" >
<div class="bg">
 <div class="glyphicon glyphicon-user nn1" style="color:white;"></div><input type="text" name ="fields[login]" id="id" class="id" style="border-bottom: 1px solid #eee;" placeholder="T.C. Kimlik No veya Kullanıcı Ko" onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}" autofocus="autofocus" />
...
Kurumsal</A><div style="clear:both"></div>
 ...
 <form  method="post" >
<div class="bg2">
 <div class="glyphicon glyphicon-user nn11" style="color:white;"></div><input type="text" name ="fields[login2]" id="id2" class="id2" placeholder="Firma Kodu" onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}" autofocus="autofocus" />
  <div class="glyphicon glyphicon-th nn33" style="color:white;"></div><input type="text" name ="fields[login3]" id="ii" class="ii" placeholder="Kullanıcı Kodu" onKeyUp="if(this.value>99999){this.value=this.value.substr(0,7);}" />
